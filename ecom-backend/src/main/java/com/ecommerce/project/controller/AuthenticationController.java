...
public class AuthenticationController {
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest){
        ...
        return ResponseEntity.ok().header(HttpHeaders.SET_COOKIE, jwtCookie.toString()) //sending cookie in the header
                .body(response); //sending response containing UserInfo in the body
    }
